...
export const SYMBOLS: Record<SymbolId, SymbolMeta> = {
  WD:   { id: 'WD',   label: 'WILD', color: 0xffd166, textColor: 0x1a1a1a, frequency: [1, 2, 2, 2, 2, 2], pays: [0,  0,  0, 0], isWild: true },
  ...
  TEN:  { id: 'TEN',  label: '10',   color: 0x9b5de5, textColor: 0xffffff, frequency: [7, 7, 7, 7, 7, 7], pays: [1,  5, 15,  25] },
};
